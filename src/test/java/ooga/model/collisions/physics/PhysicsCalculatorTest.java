...
public class PhysicsCalculatorTest {
  ...
  public void checkRightCollision() {
    ...
    Entity collider = new MainCharacter(new DefaultCollisionChart(), 50, 0, 100, 100, new EntityInfo("MARIO"), null);
  ...
  public void checkBottomCollision() {
    ...
    Entity collided = new MainCharacter(new DefaultCollisionChart(), 50, 100, 100, 50, new EntityInfo("MARIO"), null);
  ...
  public void checkThrowsException() {
    ...
    Entity collided = new MainCharacter(new DefaultCollisionChart(), 500, 1000, 100, 50, new EntityInfo("MARIO"), null);
