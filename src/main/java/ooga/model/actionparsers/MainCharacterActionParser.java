...
public class MainCharacterActionParser {
  ...
  /**
   * Parse all EndGameActions from this EndGameActionParser's ActionDataContainer and apply them to
  ...
  private MainCharacterAction parseAction(ActionData actionData) {
    ...
    if (actionData.params().size() != 0) {
      throw new ActionParsingException(
          "EndGameActions do not have any params. Invalid ActionData provided:" + actionData);
    }
