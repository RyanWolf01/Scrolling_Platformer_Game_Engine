...
/**
 * This should be called whenever two Entities have collided. When this is called, EntityA
 * will be acted upon, and EntityB WILL NOT be acted upon. To act upon EntityB, call
 * handleCollision while flipping the parameters of entityA and entityB.
 */
